...
import mathOperations from "../artifacts/contracts/MathOperations.sol/MathOperations.json";
import "./App.css";
import {
  ThemeProvider,
  createTheme,
...
function App() {
  ...
  const mathOperationsAddress = "0x5FbDB2315678afecb367f032d93F642f64180aa3"; //MODIFY THIS TO POINT TO THE ADDRESS WHERE YOU DEPLOYED THE CONTRACT
    ...
    if (window.ethereum) {
      ...
      provider.send("eth_requestAccounts", []).then(() => {
        provider.getSigner().then((signer) => {
          setContract(new Contract(mathOperationsAddress, mathOperations.abi, signer));
        });
      });
    } else {
